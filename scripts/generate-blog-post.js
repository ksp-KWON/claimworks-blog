...
- 대신, 용어를 친절하게 해설하기 위해 아래 두 가지 방식 중 하나를(혹은 둘 다) 상황에 맞게 유연하게 활용하십시오:
  ...
  2) [중간 한 줄 브리핑]: 중요한 핵심 용어가 본문 중간에 처음 등장할 때, 본문 문단 사이에 단독 줄로 인용구 블록(blockquote, '>')을 활용하여 '📖 **핵심 보상 용어 해설 : <red>[용어]</red>**\n> [설명 내용]' 또는 '📖 **핵심 보상 용어 해설 : <red>[용어]</red>** - [설명 내용]' 형태의 정돈되고 신뢰감 주는 한 줄 용어 해설 박스로 눈에 띄게 해설해 주십시오.
