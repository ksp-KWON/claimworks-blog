...
# Objective
타겟 키워드 [${topic.keywords}]를 기반으로, 구글 E-E-A-T 및 YMYL 기준을 완벽히 만족하는 **최소 7,500자 이상, 최대 15,000자 이하**의 아주 길고 방대한 분량의 초고품질 전문 칼럼을 작성합니다.

# 분량 확보를 위한 절대 규칙 (7,500자 보장)
- 본문의 H2로 구분된 모든 본론 섹션([BLOCK-4], [BLOCK-5], [BLOCK-7], [BLOCK-8], [BLOCK-10])은 단순 나열식 요약을 절대 금지하며, 각 섹션마다 **최소 3개 이상의 상세 문단(각 문단당 최소 6~10개의 서술형 문장)**으로 깊이 있게 설명해야 합니다.
...
- 각 단락과 설명은 대충 넘어가지 않고 최대한 디테일하게 기술해야 7,500자 분량 기준을 만족할 수 있습니다.
