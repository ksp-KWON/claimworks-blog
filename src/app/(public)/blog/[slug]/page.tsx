...
function RelatedPostsBox({
  ...
  return (
    <PremiumCard borderColor="blue" hoverEffect className="mt-12 !p-5 sm:!p-6 group">
      <div className="absolute right-[-10px] bottom-[-20px] opacity-[0.03] dark:opacity-[0.05] text-[#1a73e8] select-none pointer-events-none group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300">
        <AppIcon name="link" size={120} />
      </div>
      
      <div className="relative z-10 space-y-5">
        <div>
          <PremiumHeading level={3} showLeftBorder={true} gradient="blue" icon={<AppIcon name="link" size={18} />} className="!mb-0 !text-[16px]">
            함께 읽으면 도움이 되는 글
          </PremiumHeading>
