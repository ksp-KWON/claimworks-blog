        ...
        {CALCULATORS.map((calc) => {
          ...
          return (
            <Link key={calc.id} href={calc.href} className="group block outline-none">
              ...
              >
                {/* 상단 풀블리드 테마 헤더 바 */}
                <div className={`-mx-5 -mt-5 sm:-mx-7 sm:-mt-7 px-5 py-3.5 sm:px-7 sm:py-3.5 mb-4 bg-gradient-to-r ${theme.headerGradient} border-b ${theme.headerBorder} flex items-center justify-between`}>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5">
                  <div className="flex items-start gap-4">
                    {/* 테마 아이콘 */}
                    <div className={`p-3.5 border ${theme.iconBg} ${theme.iconText} shrink-0 mt-1`}>
                    ...
                    <div className="space-y-2">
                      <div>
                        <h2 className={`text-lg sm:text-xl font-black text-gray-900 dark:text-white ${theme.hoverText} transition-colors`}>
                          {calc.title}
                        </h2>
                  ...
                  <div className="shrink-0 pt-2 sm:pt-0 sm:pl-4 border-t sm:border-t-0 sm:border-l border-gray-100 dark:border-zinc-800 flex sm:flex-col items-center justify-end">
                    <div className={`w-full sm:w-auto px-5 py-3.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 ${theme.hoverBtnBg} dark:${theme.hoverBtnBg} dark:group-hover:text-white font-extrabold text-xs sm:text-sm text-center transition-all shadow-xs flex items-center justify-center gap-2`}>
