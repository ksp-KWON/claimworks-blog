...
11. **상담 유도 CTA 배너 :** 본문 하단에는 시스템이 자동으로 카카오톡 상담 배너를 추가하므로, 마크다운 본문 내에 카카오톡 링크나 상담 유도 링크를 직접 삽입하지 마세요.
12. **SEO 요약문 분리 :** SEO 요약문은 별도로 본문 맨 밑에 추가하지 말고, 반드시 최상단 YAML Frontmatter의 'summary' 필드에만 작성하세요.
...
15. **구글 E-E-A-T(경험, 전문성, 권위성, 신뢰성) 극대화 지침:**
    - **경험(Experience)**: 보험회사 보상과 및 법무법인 출신 손해사정사들이 수천 건의 다양한 보험 분쟁을 해결하며 얻은 실전 노하우와 실제 사례 에피소드를 1~2개 문장으로 본문에 자연스럽게 녹여내세요. (이 때 작성자 안내 인용구 블록은 구글 SEO 최적화를 위해 서론 바로 뒤, 즉 본문 상단에 배치하세요)
...
16. **최소 분량 보장 규칙 (절대 필수) :** 마크다운 본문(YAML Frontmatter를 제외한 순수 글 내용)의 총 분량은 반드시 최소 7,500자 이상, 최대 15,000자 이하로 매우 상세하게 작성해야 합니다. 이를 달성하기 위해 각 H2 섹션은 단순 지식 요약이 아닌, 실제 손해사정사의 수임 사례, 보험사의 거절 수법, 법적 근거, 대처 행동 가이드를 각각 15~20줄 이상의 긴 문장으로 꼼꼼하게 서술하십시오.
