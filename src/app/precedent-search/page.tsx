...
const PRACTICAL_COMMENTS: Record<string, string> = {
  ...
  '암': '암 진단비 분쟁은 주로 조직검사 결과지 상의 병리 진단 코 매칭 해석 싸움입니다. 주치의 코딩뿐만 아니라 임상학적인 암 판정 가능 여부를 추가 입증하여 보험사에 맞서야 합니다.',
...
const INITIAL_PRECEDENTS: Precedent[] = [
  ...
  },
  {
    ...
    courtName: "대법원",
    judgmentSummary: "요양병원에서의 입원 치료라 할지라도 대학병원의 항암 화학요법이나 방사선 치료 주기 도중에 발생한 필수적인 부작용 치료, 암세포 억제를 위한 필수 면역 치료 등이 병행되었다면 이는 약관에 명시된 암의 '직접적인 치료 목적 입원'에 해당하므로 관련 암입원일당을 전액 지급하는 백내장 수술입니다.",
