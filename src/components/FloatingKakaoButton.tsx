...
export default function FloatingKakaoButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-[80px] lg:bottom-6 right-6 z-50 flex items-center justify-center w-[60px] h-[60px] rounded-full bg-[#FEE500] text-[#000000] shadow-[0_8px_30px_rgba(0,0,0,0.15)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.25)] transition-shadow border border-[#FEE500] dark:border-black/10 group cursor-pointer"
