...
export default function MobileBottomNav() {
  ...
  return (
    <div 
      className={`lg:hidden fixed bottom-0 left-0 z-[100] w-full h-[48px] bg-[#e8eaed]/90 dark:bg-[#303134]/90 backdrop-blur-md border-t border-gray-300 dark:border-white/10 pb-[env(safe-area-inset-bottom,0px)] transition-transform duration-300 transform ${isVisible ? 'translate-y-0' : 'translate-y-full'}`}
    >
