  ...
  return (
    <div className="h-full flex-1 flex flex-col min-h-0 space-y-3.5 max-w-7xl mx-auto w-full overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-2.5 shrink-0">
        {/* 1. 방문 추이 그래프 (2칸) */}
        <PremiumCard borderColor="blue" hoverEffect={true} className="lg:col-span-2 !p-3.5 flex flex-col justify-between rounded-none shadow-[0_10px_30px_rgba(0,0,0,0.08)] dark:shadow-[0_10px_30px_rgba(0,0,0,0.6)] border border-gray-200/80 dark:border-white/10 relative overflow-hidden group">
        ...
        <PremiumCard borderColor="purple" hoverEffect={true} className="!p-3.5 flex flex-col justify-between rounded-none shadow-[0_10px_30px_rgba(0,0,0,0.08)] dark:shadow-[0_10px_30px_rgba(0,0,0,0.6)] border border-gray-200/80 dark:border-white/10 relative overflow-hidden group">
