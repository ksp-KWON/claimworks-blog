    ...
    <div className="flex-1 flex flex-col bg-gray-50 dark:bg-zinc-950 overflow-hidden relative">
      <div className="h-14 px-4 sm:px-6 border-b border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 flex justify-between items-center shrink-0 shadow-sm z-10 w-full overflow-x-auto">
        <div className="flex items-center gap-3 shrink-0">
          ...
          <span className="text-[10px] md:text-xs text-gray-400 font-medium hidden sm:inline">블로그에 발행된 포스팅을 관리하고 수정합니다.</span>
        </div>
          ...
          <div className="flex items-center gap-3 shrink-0 ml-4">
            <div className="relative">
              <input
                ...
                className="pl-8 pr-3 py-1.5 border border-gray-200 dark:border-zinc-700 rounded-md text-xs bg-gray-50 dark:bg-zinc-950 focus:ring-1 focus:ring-blue-500 outline-none w-[160px] md:w-[200px] transition-all"
              />
            ...
            <select
              ...
              className="px-2 py-1.5 border border-gray-200 dark:border-zinc-700 rounded-md text-xs bg-white dark:bg-zinc-900 cursor-pointer outline-none focus:ring-1 focus:ring-blue-500 transition-all font-medium"
            >
            ...
            <button 
              ...
              disabled={isLoading} 
              className="p-1.5 border border-gray-200 dark:border-zinc-700 rounded-md text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors shadow-sm"
              title="새로고침"
            >
