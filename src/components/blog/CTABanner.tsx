    ...
    <div className="mt-12 mb-8 bg-white dark:bg-[#202124] px-4 py-5 sm:p-6 rounded-none border border-gray-200 dark:border-white/10 shadow-[0_12px_40px_rgba(0,0,0,0.06)] dark:shadow-[0_12px_40px_rgba(0,0,0,0.4)] hover:shadow-[0_16px_50px_rgba(26,115,232,0.18)] hover:border-[#1a73e8] transition-all duration-300 relative overflow-hidden group">
      <div className="relative z-10 space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          <Link
            href="/about"
            className="flex items-center gap-3 p-3 rounded-none bg-white dark:bg-[#202124] border border-gray-200 dark:border-white/10 shadow-sm hover:shadow-[0_8px_25px_rgba(99,102,241,0.18)] hover:border-indigo-500 hover:bg-gradient-to-br hover:from-indigo-50/80 hover:to-blue-50/80 dark:hover:from-indigo-900/15 dark:hover:to-blue-900/15 hover:-translate-y-0.5 transition-all duration-300 group"
          >
            <div className="w-10 h-10 rounded-none bg-gradient-to-br from-indigo-100 to-indigo-50 dark:from-indigo-900/30 dark:to-indigo-900/10 border border-indigo-200 dark:border-indigo-800/40 flex items-center justify-center shrink-0 shadow-xs group-hover:scale-105 transition-transform">
              <AppIcon name="user" size={20} className="text-indigo-600 dark:text-indigo-400" />
            </div>
            <div className="min-w-0 flex-1">
              <span className="block text-sm font-bold text-[#202124] dark:text-[#e8eaed] truncate group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">보상스쿨 소개</span>
