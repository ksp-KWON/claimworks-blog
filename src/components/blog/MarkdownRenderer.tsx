...
const baseComponents: Components = {
  ...
  blockquote: ({ children }) => {
    ...
    const bgColors: Record<string, string> = {
      blue: 'bg-blue-50/50 dark:bg-blue-900/10 border-l-[var(--google-blue)] [&_h3]:border-l-[var(--google-blue)] [&_h3]:bg-gradient-to-r [&_h3]:from-blue-50 [&_h3]:to-transparent [&_h3]:dark:from-blue-900/20 [&_h3]:dark:to-transparent [&_h3_span:last-child]:text-[var(--google-blue)] [&_h3_span:last-child]:dark:text-blue-400',
      red: 'bg-red-50/50 dark:bg-red-900/10 border-l-[var(--google-red)] [&_h3]:border-l-[var(--google-red)] [&_h3]:bg-gradient-to-r [&_h3]:from-red-50 [&_h3]:to-transparent [&_h3]:dark:from-red-900/20 [&_h3]:dark:to-transparent [&_h3_span:last-child]:text-[var(--google-red)] [&_h3_span:last-child]:dark:text-red-400',
      green: 'bg-green-50/50 dark:bg-green-900/10 border-l-[var(--google-green)] [&_h3]:border-l-[var(--google-green)] [&_h3]:bg-gradient-to-r [&_h3]:from-green-50 [&_h3]:to-transparent [&_h3]:dark:from-green-900/20 [&_h3]:dark:to-transparent [&_h3_span:last-child]:text-[var(--google-green)] [&_h3_span:last-child]:dark:text-green-400',
      yellow: 'bg-yellow-50/50 dark:bg-yellow-900/10 border-l-yellow-500 [&_h3]:border-l-yellow-500 [&_h3]:bg-gradient-to-r [&_h3]:from-yellow-50 [&_h3]:to-transparent [&_h3]:dark:from-yellow-900/20 [&_h3]:dark:to-transparent [&_h3_span:last-child]:text-yellow-600 [&_h3_span:last-child]:dark:text-yellow-400',
      purple: 'bg-purple-50/50 dark:bg-purple-900/10 border-l-purple-500 [&_h3]:border-l-purple-500 [&_h3]:bg-gradient-to-r [&_h3]:from-purple-50 [&_h3]:to-transparent [&_h3]:dark:from-purple-900/20 [&_h3]:dark:to-transparent [&_h3_span:last-child]:text-purple-600 [&_h3_span:last-child]:dark:text-purple-400',
    };
    return (
      <PremiumCard hoverEffect={false} className={`my-7 !p-5 sm:!p-6 border-l-4 shadow-sm ${bgColors[tone]}`}>
        <div className="text-[14.5px] sm:text-[15px] font-medium text-gray-700 dark:text-[#e8eaed] leading-[1.7] tracking-tight [&>p]:m-0 break-keep [&_h3]:text-base [&_h3]:border-b [&_h3]:border-gray-200 dark:[&_h3]:border-white/10 [&_h3]:pb-3 [&_h3]:mb-3 [&_h3]:!mt-0 [&_h3]:gap-1.5 [&_h3]:border-l-4 [&_h3]:pl-3 [&_h3]:pr-6 [&_h3]:py-1.5 [&_h3]:rounded-r-md">
          {children}
        </div>
      </PremiumCard>
    );
