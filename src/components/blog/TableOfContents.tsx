...
export default function TableOfContents({
  ...
  return (
    <nav className="my-10 bg-white dark:bg-[#202124] p-5 sm:p-6 border border-blue-200 dark:border-blue-900/50 shadow-[0_4px_20px_rgba(0,0,0,0.03)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.2)] relative overflow-hidden group">
