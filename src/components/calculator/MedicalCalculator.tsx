      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
        ...
        <div className="lg:col-span-7 lg:sticky lg:top-[100px] flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2 mt-2">
            <button onClick={() => window.open('https://open.kakao.com/o/sWeszp7', '_blank', 'noopener,noreferrer')} className="flex items-center justify-center w-full gap-2 py-4 bg-[#1a73e8] hover:bg-[#1557b0] text-white rounded-none font-bold text-[14px] sm:text-[15px] transition-all shadow-sm hover:shadow-md" id="medical-calc-chat-btn">
