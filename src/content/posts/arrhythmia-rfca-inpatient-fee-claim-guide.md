...
> ### 보상스쿨 피드백 & 실무 인사이트
>
> 보험사가 입원비를 통원으로 삭감할 때 흔히 내세우는 '**R:단순 회복실 체류 논리**'는 부당합니다. 하지만 수술 후 환자가 일반 병실로 이동하여 지속적인 심전도 모니터링과 의료진의 처치를 받았다면 이는 명백한 입원입니다. 진료기록부 상에 의사의 입원 오더와 활력징후 모니터링 내역이 기재되어 있는지 반드시 선행 확인해야 합니다.
