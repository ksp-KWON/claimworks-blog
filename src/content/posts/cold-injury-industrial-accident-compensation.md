...
- **P:산업재해보상보험법상 업무상 질병 인정 기준** : 한랭질환은 단순 체질 문제가 아니며, 한파 속 지속적인 옥외 작업과의 인과관계가 의학적으로 입증되면 산재 승인 대상입니다.

- **E:근재보험을 통한 초과 손해액 정당한 청구** : 산재 승인 이후 발생하는 위자료, 향후치료비, 일실이익 등 초과 손해액은 맥브라이드 장해평가를 거쳐 온전히 청구해야 합니다.

- **R:보험사의 기왕증 감액 주장과 과실 비율 차단** : 직업환경의학적 정밀 소견과 기상청 한파특보 등 객관적 데이터를 기반으로 감액 시도를 방어해야 합니다.
...
> ### 보상스쿨 피드백 & 실무 인사이트
>
> 한파 속 옥외 작업으로 인한 한랭질환(동상 및 심부 체온 저하)에 대해 보험사가 "개인 체질 문제나 기왕증"이라며 책임을 회피할 때는 **A:기상청 한파특보 데이터와 사업주의 방한 장구 미지급 실태**를 즉각 입증해야 합니다. 산재 승인에 그치지 않고 **P:맥브라이드 장해평가를 통한 노동능력상실률 입증**으로 **E:근재보험 초과 위자료 및 일실손해 전액**을 온전히 확보하시길 권합니다.
