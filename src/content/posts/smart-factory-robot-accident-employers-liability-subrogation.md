...
### 근재보험의 보상 범위와 특징**근재보험(근로자재해보험)**은 산업재해보상보험법(산재보험)으로 보상받지 못하는 손해, 즉**산재보험 초과 손해**를 보상하는 보험입니다. 로봇 사고의 경우, 기업의 안전 관리 의무 위반 등 과실이 인정되면 산재보험에서 지급되는 급여 외에 추가적인 손해배상 책임이 발생하며, 이를 근재보험으로 보상받을 수 있습니다.
