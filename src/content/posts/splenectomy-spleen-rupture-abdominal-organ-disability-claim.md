...
* **지급액 산정 공식** : `후유장해 가입금액 x 장해지급률`
* 예시 : 후유장해 가입금액이 2억 원이고 2017년에 가입한 경우, `2억 원 x 20% = 4,000만 원`이 기준 금액이 됩니다.
...
1. **월 상실수익액** : `400만 원 x 15%(장해율) = 60만 원`
2. **중간이자 공제 후 총액** : `60만 원 x 190(호프만 또는 라이프니츠 계수) = 1억 1,400만 원`
3. **과실 상계 적용 (본인 과실 20%)** : `1억 1,400만 원 x 80% = 9,120만 원`
