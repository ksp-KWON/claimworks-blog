...
export function getUniversalAnalyticsData(period: '24h' | '7d' | '30d'): UniversalAnalyticsData {
  ...
  return {
    ...
    topPages: [
      ...
      { path: '/blog/rotator-cuff-tear-traumatic-injury-claim-guide', title: '어깨 회전근개 파열 M코드 상해 인정 및 외상 기여도 입증법', views: 1280 },
      ...
      { path: '/blog/dental-implant-bone-graft-surgery-fee-dispute', title: '임플란트 치조골 이식술 삭감 통보? 종수술비 전액 수령하는 핵심 보상 가이드', views: 760 },
      { path: '/blog/non-muscle-invasive-bladder-cancer-general-claim-guide', title: '비근침윤성 방광암(Ta) 제자리암 삭감 방어 및 일반암 진단비 수령법', views: 720 },
    ],
    topReferrers: [
