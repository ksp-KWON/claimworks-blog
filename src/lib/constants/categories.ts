...
export const CATEGORY_THEME_STYLES = {
  ...
  rose: {
    ...
    hoverShadow: 'hover:shadow-[0_12px_40px_rgba(244,63,94,0.18)] dark:hover:shadow-[0_12px_40px_rgba(244,63,94,0.25)]',
    accentBar: 'bg-rose-600',
    gradient: 'from-rose-100/70 via-rose-50/25 to-transparent dark:from-rose-950/30 dark:via-rose-950/10 dark:to-transparent',
  ...
  sky: {
    ...
    hoverShadow: 'hover:shadow-[0_12px_40px_rgba(14,165,233,0.18)] dark:hover:shadow-[0_12px_40px_rgba(14,165,233,0.25)]',
    accentBar: 'bg-sky-600',
    gradient: 'from-sky-100/70 via-sky-50/25 to-transparent dark:from-sky-950/30 dark:via-sky-950/10 dark:to-transparent',
  ...
  red: {
    ...
    hoverShadow: 'hover:shadow-[0_12px_40px_rgba(239,68,68,0.18)] dark:hover:shadow-[0_12px_40px_rgba(239,68,68,0.25)]',
    accentBar: 'bg-red-600',
    gradient: 'from-red-100/70 via-red-50/25 to-transparent dark:from-red-950/30 dark:via-red-950/10 dark:to-transparent',
  ...
  emerald: {
    ...
    hoverShadow: 'hover:shadow-[0_12px_40px_rgba(16,185,129,0.18)] dark:hover:shadow-[0_12px_40px_rgba(16,185,129,0.25)]',
    accentBar: 'bg-emerald-600',
    gradient: 'from-emerald-100/70 via-emerald-50/25 to-transparent dark:from-emerald-950/30 dark:via-emerald-950/10 dark:to-transparent',
  ...
  orange: {
    ...
    hoverShadow: 'hover:shadow-[0_12px_40px_rgba(249,115,22,0.18)] dark:hover:shadow-[0_12px_40px_rgba(249,115,22,0.25)]',
    accentBar: 'bg-orange-600',
    gradient: 'from-orange-100/70 via-orange-50/25 to-transparent dark:from-orange-950/30 dark:via-orange-950/10 dark:to-transparent',
  ...
  purple: {
    ...
    hoverShadow: 'hover:shadow-[0_12px_40px_rgba(168,85,247,0.18)] dark:hover:shadow-[0_12px_40px_rgba(168,85,247,0.25)]',
    accentBar: 'bg-purple-600',
    gradient: 'from-purple-100/70 via-purple-50/25 to-transparent dark:from-purple-950/30 dark:via-purple-950/10 dark:to-transparent',
  ...
  amber: {
    ...
    hoverShadow: 'hover:shadow-[0_12px_40px_rgba(245,158,11,0.18)] dark:hover:shadow-[0_12px_40px_rgba(245,158,11,0.25)]',
    accentBar: 'bg-amber-600',
    gradient: 'from-amber-100/70 via-amber-50/25 to-transparent dark:from-amber-950/30 dark:via-amber-950/10 dark:to-transparent',
  ...
  blue: {
    ...
    hoverShadow: 'hover:shadow-[0_12px_40px_rgba(59,130,246,0.18)] dark:hover:shadow-[0_12px_40px_rgba(59,130,246,0.25)]',
    accentBar: 'bg-blue-600',
    gradient: 'from-blue-100/70 via-blue-50/25 to-transparent dark:from-blue-950/30 dark:via-blue-950/10 dark:to-transparent',
  ...
  teal: {
    ...
    hoverShadow: 'hover:shadow-[0_12px_40px_rgba(20,184,166,0.18)] dark:hover:shadow-[0_12px_40px_rgba(20,184,166,0.25)]',
    accentBar: 'bg-teal-600',
    gradient: 'from-teal-100/70 via-teal-50/25 to-transparent dark:from-teal-950/30 dark:via-teal-950/10 dark:to-transparent',
