...
const DOMAIN_COMMON_WORDS = new Set([
  ...
  // 법률/청구/분쟁 일반어
  '약관', '특약', '청구', '지급', '부지급', '삭감', '거절', '면책', '해지', '무효', '취소', '소송', '판례', '대법원', '하급심', '금감원', '분쟁', '합의', '과실', '과실비율', '인과관계', '입증', '소명', '손해', '피해', '피해자', '가해자', '피보험자', '계약자', '수익자', '채무부존재', '구상금', '구상권', '판결', '승소', '패소',
  // 의료/진료 및 일반 상태어
  ...
  // 블로그 수식어/불용어/접미사
  '이것', '저것', '그것', '모르면', '알면', '받는', '방법', '전략', '가이드', '포인트', '핵심', '주의사항', '대응', '대응법', '해결책', '사례', '총정리', '완벽', '정리', '필독', '확인', '이유', '어떻게', '알아보기', '주의', '비교', '대비', '필수', '체크', '노하우', '청구법', '하는법', '받는법', '팁', '경우', '대한', '위한', '통해', '대해', '어떤', '모든', '실제', '바로', '진짜', '당일', '첫날', '내원', '기준', '분류', '단계', '선임', '상담', '비결', '돌파', '해결', '성공', '주의점', '입증법', '대처법', '해결법', '방어법', '환수법', '청구방법', '대응방법'
]);
