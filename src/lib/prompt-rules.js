...
## 11. 🔴 [핵심 윤문 규칙] 궁극의 전문가 휴머나이징(Humanizing) 및 번역투 완전 제거
...
## 9. 마무리 정리 블록 (출력 절대 금지)
- 본문 작성 완료 후 '[추천 제목]', '핵심정리 :', '섹션별 요약 :' 등의 별도 요약이나 패턴 제목을 **절대 출력하지 마세요**. 본문은 FAQ 또는 마무리 문장으로 자연스럽게 종료해야 합니다.
