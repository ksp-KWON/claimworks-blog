...
## 4. 강조 마크다운 활용 규칙 (HTML 태그 절대 금지)
- 본문 텍스트 내에 특정 키워드를 강조할 때는 절대 임의의 HTML 태그(<red>, <blue> 등)를 사용하지 마십시오. Markdown 파싱 에러를 유발합니다.
- 대신 상황에 맞는 볼드체('**강조할 단어**')를 결합하여 자연스럽게 강조하십시오.
