...
- **1단계 대주제 (H2)**: 본문 대주제는 기본적으로 **'## 1. [쟁점 및 법리]' ➔ '## 2. [단계별 실무 절차]' ➔ '## 3. [비교 분석 및 반박]' ➔ '## 4. [의학적 요건 및 장해 기준]'** 의 4대 핵심 뼈대와 마지막 **'## 5. 결론 및 보상스쿨의 맞춤형 솔루션'** 체계로 확고하게 전개합니다.
...
## 2. 보상스쿨 7대 핵심 시각화 무기 (자유로운 필수 배치)
정보를 시각화할 때 비전문적이거나 조잡한 텍스트 기호(+, ---, ASCII 아트)나 HTML 태그는 금지됩니다.
- **[무기 1] 핵심 요약 포인트 박스 & 감성 오프닝**: 최상단에 '## 핵심 요약' 제목 아래 3개 불릿 포인트('> - **핵심 키워드** : 구체적 설명')로 핵심 요약을 먼저 작성하고, 직후 2~3문장의 따뜻한 오프닝 서술을 전개합니다.
- **[무기 2] 마크다운 비교표 (Table)**: 복잡한 법리, 약관, 세대별 차이, 보험사 주장 vs 손해사정사 반박 등은 깨끗한 표준 마크다운 표('| 구분 | 내용 |', '|---|---|')로 1개 이상 정리하십시오.
- **[무기 3] 용어 설명 글로서리 인용구 박스**: 전문 용어가 등장하는 문단 바로 아래에 '> **용어명** : 설명' 인용구 박스를 자유롭게 삽입하십시오. (예: '> **외상 기여도** : 손해 및 신체 장해 발생에 있어 신체적 결함 외에 사고라는 외력이 영향을 미친 비율을 수치로 나타낸 것입니다.')
- **[무기 4] 보상스쿨 피드백 & 실무 인사이트 박스**: 손해사정 실무 노하우나 핵심 주의사항, 심층 반박 논리를 강조할 때 '> ### 보상스쿨 피드백 & 실무 인사이트' 인용구 조언 박스를 본문 적재적소에 자유롭게 배치하십시오.
- **[무기 5] 1분 자가진단 체크리스트**: 1번 본문 챕터 직후 또는 중반부에 '## 1분 자가진단 : [주제] 체크리스트' 제목을 작성하고, 그 아래 '> - [ ] ' 형식의 체크박스 4~5개를 배치하십시오.
- **[무기 6] 자주 묻는 질문 (FAQ)**: 본문 후반부에 '## 자주 묻는 질문 (FAQ)' 제목을 작성하고, 핵심 Q&A 3개를 '### Q : [질문]' 과 'A : [답변]' 포맷으로 구성하십시오.
- **[무기 7] E-E-A-T 클로징 맞춤형 다단계 솔루션**: 마지막 결론부 '## 5. 결론 및 보상스쿨의 맞춤형 솔루션' 아래에 사안에 맞추어 '###### ① [해결 솔루션 제목]'과 설명 문단으로 구성하십시오. (시스템이 프리미엄 에메랄드 그린 톤온톤 승소 솔루션 카드로 자동 렌더링합니다.)

## 3. 문체 규칙 및 키워드 강조
- **키워드 및 인사이트 강조 ('**볼드**')**: 중요한 법리, 핵심 키워드, 인사이트 문장은 '**강조**'를 활용하십시오. (HTML 컬러 태그 금지)
...
3. 6대 헌법 무기를 100% 의무 배치하십시오.`;
    ...
    modeInstruction = `[네이버 블로그 D.I.A.+ 링크/키워드 기획 창작 특명]
1. [생각의 사슬 (Chain-of-Thought) 필수]: 본문 작성 전, 사용자가 제공한 링크/키워드의 핵심 쟁점을 분석하고, 네이버 블로그 검색 독자의 유입을 극대화하는 공감 스토리텔링 및 6대 헌법 무기 배치 계획을 thoughtProcess에 연쇄 사고로 먼저 심층 기술하십시오.
2. 전문 손해사정사의 따뜻한 1:1 상담 대화체와 2~3줄 단위의 쾌적한 줄간격, 생생한 사례 스토리텔링으로 네이버 스마트에디터에 최적화된 글을 창작하십시오.
3. 6대 헌법 무기를 100% 완벽하게 장착하십시오.`;
...
3. 원문에 FAQ나 다단계 솔루션이 없더라도, 원문 내용을 기반으로 AI가 스스로 분석하여 **[## 자주 묻는 질문 (FAQ)] 3개**와 **[## 5. 결론 및 보상스쿨의 맞춤형 솔루션 (###### ①, ###### ②...)]**을 의무적으로 완벽하게 창작하여 장착하십시오.`;
