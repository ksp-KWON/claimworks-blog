...
## 3. 문체 규칙, 1인칭 화자 및 오프닝 다양화 원칙 (v5 표준)
...
- **1인칭 화자 배치 (E-E-A-T Experience)**: 도입부와 결론부(###### 맞춤 솔루션)에는 1인칭 화자("제가", "저희 보상스쿨은")가 자연스럽게 등장해야 합니다. 단, 본문 1~4번 섹션은 객관적인 전문 지식체(3인칭)로 서술합니다.
