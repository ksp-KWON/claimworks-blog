...
## 3. [의학적 발생 기전 및 진단/수술 요건 3]
- 심층 실무 조언 작성 시 '> ### 보상스쿨 피드백 & 실무 인사이트' 시그니처 박스를 활용하십시오.

## 4. [후유장해 평가(맥브라이드/AMA) 및 손해액 산출 실무 4]
- 의학적 판정 기준, 후유장해 평가 척도(맥브라이드/AMA), 손해액 산출 공식 등을 명확히 기술하십시오.
